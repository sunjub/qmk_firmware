...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {\
    ...
    KC_LSFT,      KC_A,   KC_S,     KC_D,     KC_F,     KC_G,	    KC_LBRC,  KC_RBRC,  KC_H,    KC_J,    KC_K,   KC_L,   KC_EQL,    DELRALT,\
                  KC_Z,   KC_X,     KC_C,     KC_V,     KC_B,     KC_COMM,  KC_DOT,   KC_N,    KC_M,    KC_SCLN,KC_UP,  KC_RGHT,\
                          QK_LEAD,  KC_LALT,  CTLLSH,   SPCFN1,                       ENTCTL,  CTLQOT,  KC_LEFT,KC_DOWN,\
                                                        TABFN2,                       INSALT,\
                                            KC_UP,                                                  KC_VOLU,\
...
void leader_end_user(void) {
  // Windows key
    ...
    } else if (leader_sequence_two_keys(KC_W, KC_T)) {
    ...
    } else if (leader_sequence_three_keys(KC_C, KC_A, KC_E)) {
